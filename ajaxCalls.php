...
<?php
   ...
   if($_POST['action'] == 'saveStudentData'){
       ...
       $resume = '';
       $sql= "insert into student (certificateNumber, firstName, lastName, fatherOrHusbandName, DOB, age, address, mobile, alternateNumber, email, batch, college, SSLCYearOfPassing, SSLCPercentage, PUCYearOfPassing, PUCPercentage, DiplomaYearOfPassing, DiplomaPercentage, UGYearOfPassing, UGPercentage,PGYearOfPassing, PGPercentage, skills, courseStudied, duration, certificateIssueDate, Grade, Remarks, Working, OrganizationName, Designation, LookingForJob, AboutMEA, Resume) values('$certiNum', '$firstName', '$lastName', '$fatherName', '$DOB', '$age', '$address', '$mobile', '$alternateNumber', '$email', '$batch', '$college', '$sslcYOP', '$sslcPer', '$puYOP', '$puPer', '$dipYOP', '$dipPer', '$ugYOP', '$ugPer', '$pgYOP', '$pgPer', '$skills', '$course', '$duration', '$certificateIssueDate', '$grade', '$remarks', '$working', '$organizationName', '$designation', '$lookingForJob', '$about','$resume')";
       $result=mysqli_query($mysqli,$sql);
       if($result){
           echo "sucess";
       }else{
