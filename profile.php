            ...
            <div class="col-md-7">
              <table class="table">
                <tbody>
				  ...
				  <tr>
                    <td class="p-12 textBold">Batch</td>
                    <td class="p-12"><?php echo $row['batch']!=null ? $row['batch'] : "NA" ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="p-12 textBold">College</td>
                    <td class="p-12">
                      <span><?php echo $row['batch']!=null ? $row['college'] : "NA" ?></span>
                    </td>
                  </tr>
				  <tr>
