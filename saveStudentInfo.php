                  ...
                  <div class="tab-pane" id="tab1">
					...
					<div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>Batch</label>
                          <input type="text" class="form-control batch" name="batch" placeholder="Batch" value="">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>College Name</label>
                          <input type="text" class="form-control collegeName" name="collegeName" placeholder="College Name" value="">
                        </div>
                      </div>
                    </div>
                    <div class="row">
